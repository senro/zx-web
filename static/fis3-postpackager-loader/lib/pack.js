...
module.exports = function(file, resource, ret, opts) {
  ...
  pack(resource.js, opts.js || 'pkg/${filepath}_aio.js',opts.urlJs || 'pkg/${filepath}_aio.js');
  pack(resource.css, opts.css || 'pkg/${filepath}_aio.css',opts.urlCss || 'pkg/${filepath}_aio.css');
  ...
  function pack(list, fileTpl,urlTpl) {
    var index = 1;
    var i = 0;
    var unpacked = [];
    var item;
    ...
    function _pack() {
      ...
      //console.log(filepath);
        var urlpath = common.tokenizePath(urlTpl, {
            filepath: file.subpath,
            hash: file.getHash()
        });
        //console.log(urlpath);
