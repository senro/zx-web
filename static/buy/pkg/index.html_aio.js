...
/*!components/waitBuy/searchToBuy_section/searchToBuy_section.js*/
;/**
 * Created with PhpStorm.
 * User: Administrator
 * Date: 2015/10/23
    ...
    App.page('searchToBuy', function () {
        ...
        this.init = function () {
            ...
            $currentSection.find('.goodsList').on('tap','.btn-checkbox',function(){
                ...
                if(!$thisCheckBtn.hasClass('active')){
                ...
                if($this.attr('data-btnId')){
                    switch (btnId){
                        case 0:
                            ...
                            $thisCheckBtn.removeClass('color-blue active');
                            break;
                        case 1:
                            ...
                            $thisCheckBtn.removeClass('color-yellow active');
                            break;
                        case 2:
                            ...
                            $thisCheckBtn.removeClass('color-orange active');
                            break;
                        case 3:
                            ...
                            $thisCheckBtn.removeClass('color-skyBlue active');
                            break;
                    }
                }
                return false;
