...
define(function(require, exports, module) {
    ...
    var $ = require('jquery'),
	    dateCss = require('./datetimepicker.css');
	...
	var Datetimepicker = function (element, options) {
		...
		this.language = options.language || this.element.data('date-language') || "chn";
		this.language = this.language in dates ? this.language : "chn";
    ...
    //require('spm_modules/datetimepicker/locales/datetimepicker.zh-CN.js');
